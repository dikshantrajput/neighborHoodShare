<div class="container mx-auto py-8 px-4">
    ...
    <ul class="list-disc pl-4 mb-8">
      <li class="">Peer ID: A unique identifier generated by the application to establish connections within the network. You choose to share this ID with others to connect and share files.</li>
      <li class="">Usage Data: We may collect anonymous usage data about your interaction with the application, such as features used, frequency of use, and any error reports. This data helps us improve the application and user experience.</li>
    </ul>
    ...
    <ul class="list-disc pl-4 mb-8">
      ...
      <li class="">To improve the application and user experience</li>
      <li class="">To analyze usage trends and identify potential improvements</li>
      <li class="">To comply with legal obligations</li>
    </ul>
  </div>
